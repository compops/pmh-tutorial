...
plot(data1$x,col="#1B9E77",lwd=1.5,type="l",xlab="time",ylab="latent state",bty="n",ylim=c(-0.5,1.5))
polygon(c(grid,rev(grid)),c(data1$x,rep(-0.5,T)),border=NA,col=rgb(t(col2rgb("#1B9E77"))/256,alpha=0.25))

plot(data1$y,col="#1B9E77",lwd=1.5,type="l",xlab="time",ylab="measurement",bty="n",ylim=c(-4,4))
...
polygon(c(foo$lag,rev(foo$lag)),c(rep(1.96/sqrt(T),length(foo$lag)),rev(rep(-1.96/sqrt(T),length(foo$lag)))),border=NA,col=rgb(t(col2rgb("darkgrey"))/256,alpha=0.15))

plot(data2$x,col="#D95F02",lwd=1.5,type="l",xlab="time",ylab="latent state",bty="n",ylim=c(-0.5,1.5))
polygon(c(grid,rev(grid)),c(data2$x,rep(-0.5,T)),border=NA,col=rgb(t(col2rgb("#D95F02"))/256,alpha=0.25))

plot(data2$y,col="#D95F02",lwd=1.5,type="l",xlab="time",ylab="measurement",bty="n",ylim=c(-4,4))
...
plot(data3$x,col="#7570B3",lwd=1.5,type="l",xlab="time",ylab="latent state",bty="n",ylim=c(-0.5,1.5))
polygon(c(grid,rev(grid)),c(data3$x,rep(-0.5,T)),border=NA,col=rgb(t(col2rgb("#7570B3"))/256,alpha=0.25))

plot(data3$y,col="#7570B3",lwd=1.5,type="l",xlab="time",ylab="measurement",bty="n",ylim=c(-4,4))
